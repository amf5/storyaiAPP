...
@Configuration
@EnableKafka
public class KafkaConsumerBookConfig {

    @Bean
    public ConsumerFactory<String, BookMessage> bookConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BookMessage> bookKafkaListenerContainerFactory() {
